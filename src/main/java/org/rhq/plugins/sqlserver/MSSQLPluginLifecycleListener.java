...
public class MSSQLPluginLifecycleListener implements PluginLifecycleListener {
    private final Log log = LogFactory.getLog(MSSQLPluginLifecycleListener.class);
